...
// Query: *[_type == "settings"][0]{  _id,  title,  description,  ogImage{    asset->,    alt,    metadataBase  },  contactEmail,  bookingUrl,  socialLinks[]{    platform,    url  },  showShowsPage,  showLessonsPage,  showSetlistPage,  showAmpsPage,  showMerchPage,  showContactPage}
