...
// Query: *[_type == "showsPage"][0]{  _id,  heroHeading,  heroSubheading,  heroImage{asset->{_id, url}, hotspot, crop, desktopPosition, mobilePosition, alt},  heroMobileImage{asset->{_id, url}, hotspot, crop, desktopPosition, mobilePosition, alt},  performanceGalleryHeading,  performanceGallerySubheading,  performanceImages[]{    _key,    image{asset->{_id, url}, hotspot, crop, desktopPosition, mobilePosition, alt},    alt,    caption  },  upcomingShowsHeading,  pastShowsHeading,  emptyStateHeading,  emptyStateText,  showCountPrefix,  showSingular,  showPlural,  statsLabel1,  statsLabel2,  statsLabel3,  eventDetailsLabel,  lineupHeading,  dateTimeLabel,  venueLabel,  viewOnMapText,  getTicketsText,  soldOutText,  backToShowsText,  shareEventText,  importantInfoText,  canceledBadgeText,  soldOutBadgeText,  canceledMessageText,  seoTitle,  seoDescription,  defaultEventImage{asset->{_id, url}, hotspot, crop, alt}}
...
// Query: *[_type == "lessonPackage" && active == true && archived != true] | order(order asc, priceCents asc) {  _id,  title,  "slug": slug.current,  tagline,  image{    asset->,    alt  },  priceCents,  currency,  compareAtPriceCents,  duration,  sessionsCount,  sessionLength,  level,  format,  features,  includes,  featured,  badge,  active}
...
// Query: *[_type == "event" && startDateTime >= $now && !isCanceled && archived != true] | order(startDateTime asc)[0...$limit]{  _id,  title,  "slug": slug.current,  excerpt,  startDateTime,  endDateTime,  timezone,  venue,  address,  city,  state,  country,  ticketUrl,  description,  coverImage{asset->, hotspot, crop, desktopPosition, mobilePosition, alt},  isCanceled,  isSoldOut}
...
// Query: *[_type == "event" && startDateTime < $now && archived != true] | order(startDateTime desc)[$offset...$limit]{  _id,  title,  startDateTime,  timezone,  venue,  city,  state,  country,  coverImage{asset->, hotspot, crop, desktopPosition, mobilePosition, alt}}
...
// Query: *[_type == "event" && dateTime(startDateTime) >= dateTime($startOfMonth) && dateTime(startDateTime) < dateTime($endOfMonth) && archived != true] | order(startDateTime asc){  _id,  title,  startDateTime,  timezone,  venue,  city,  ticketUrl,  isCanceled,  isSoldOut}
...
// Query: *[_type == "event" && archived != true]{  "slug": coalesce(slug.current, _id)}
export type EventsSlugsResult = Array<{
  slug: string;
}>;
// Variable: allProductsQuery
// Query: *[_type == "product" && archived != true] | order(featured desc, _createdAt desc){  _id,  title,  "slug": slug.current,  "image": images[0]{    "asset": asset->{      _id,      url,      metadata {        lqip,        dimensions      }    },    hotspot,    crop,    desktopPosition,    mobilePosition,    alt  },  priceCents,  compareAtPriceCents,  onSale,  currency,  category,  stockStatus,  featured,  badges,  tags,  inventoryQuantity,  trackInventory,  lowStockThreshold,  "hasOptions": count(options) > 0}
...
// Query: *[_type == "product" && featured == true && archived != true] | order(_createdAt desc)[0...$limit]{  _id,  title,  "slug": slug.current,  "image": images[0]{    "asset": asset->{_id, url, metadata{lqip, dimensions}},    hotspot, crop, desktopPosition, mobilePosition, alt  },  priceCents,  compareAtPriceCents,  onSale,  currency,  category,  stockStatus,  featured,  badges,  tags,  inventoryQuantity,  trackInventory,  lowStockThreshold,  "hasOptions": count(options) > 0}
...
// Query: *[_type == "product" && archived != true && (  title match $searchTerm  || category match $searchTerm  || tags[] match $searchTerm)] | order(_score desc, _createdAt desc)[0...$limit]{  _id,  title,  "slug": slug.current,  images[0]{asset->, hotspot, crop, desktopPosition, mobilePosition, alt},  priceCents,  compareAtPriceCents,  onSale,  currency,  category,  stockStatus,  badges,  tags}
...
// Query: *[_type in ["product", "event"] && defined(slug.current) && archived != true] | order(_type asc){  "slug": slug.current,  _type,  _updatedAt,  _type == "event" => {    startDateTime,    isCanceled  }}
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"event\" && dateTime(startDateTime) >= dateTime($startOfMonth) && dateTime(startDateTime) < dateTime($endOfMonth) && archived != true] | order(startDateTime asc){\n  _id,\n  title,\n  startDateTime,\n  timezone,\n  venue,\n  city,\n  ticketUrl,\n  isCanceled,\n  isSoldOut\n}": EventsByMonthQueryResult;
    ...
    "*[_type == \"event\" && archived != true]{\n  \"slug\": coalesce(slug.current, _id)\n}": EventsSlugsResult;
    "*[_type == \"product\" && archived != true] | order(featured desc, _createdAt desc){\n  _id,\n  title,\n  \"slug\": slug.current,\n  \"image\": images[0]{\n    \"asset\": asset->{\n      _id,\n      url,\n      metadata {\n        lqip,\n        dimensions\n      }\n    },\n    hotspot,\n    crop,\n    desktopPosition,\n    mobilePosition,\n    alt\n  },\n  priceCents,\n  compareAtPriceCents,\n  onSale,\n  currency,\n  category,\n  stockStatus,\n  featured,\n  badges,\n  tags,\n  inventoryQuantity,\n  trackInventory,\n  lowStockThreshold,\n  \"hasOptions\": count(options) > 0\n}": AllProductsQueryResult;
    ...
    "*[_type == \"product\" && defined(slug.current) && archived != true]{\n  \"slug\": slug.current\n}": ProductSlugsQueryResult;
    "*[_type == \"product\" && category == $category && _id != $excludeId && archived != true] | order(_createdAt desc)[0...$limit]{\n  _id,\n  title,\n  \"slug\": slug.current,\n  \"image\": images[0]{\n    \"asset\": asset->{_id, url, metadata{lqip, dimensions}},\n    hotspot, crop, desktopPosition, mobilePosition, alt\n  },\n  priceCents,\n  compareAtPriceCents,\n  onSale,\n  currency,\n  stockStatus,\n  badges,\n  inventoryQuantity,\n  trackInventory,\n  lowStockThreshold,\n  \"hasOptions\": count(options) > 0\n}": RelatedProductsByCategoryQueryResult;
    "*[_type == \"product\" && featured == true && archived != true] | order(_createdAt desc)[0...$limit]{\n  _id,\n  title,\n  \"slug\": slug.current,\n  \"image\": images[0]{\n    \"asset\": asset->{_id, url, metadata{lqip, dimensions}},\n    hotspot, crop, desktopPosition, mobilePosition, alt\n  },\n  priceCents,\n  compareAtPriceCents,\n  onSale,\n  currency,\n  category,\n  stockStatus,\n  featured,\n  badges,\n  tags,\n  inventoryQuantity,\n  trackInventory,\n  lowStockThreshold,\n  \"hasOptions\": count(options) > 0\n}": FeaturedProductsQueryResult;
    ...
    "*[_type in [\"product\", \"event\"] && defined(slug.current) && archived != true] | order(_type asc){\n  \"slug\": slug.current,\n  _type,\n  _updatedAt,\n  _type == \"event\" => {\n    startDateTime,\n    isCanceled\n  }\n}": SitemapQueryResult;
  }
}
